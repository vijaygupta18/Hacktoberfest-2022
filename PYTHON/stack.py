#this file contains all the properties of stack implemented in python.
#Also some basic problems that were solved using stacks.
...
####### popular Questions related to stack ####### 
#  input =  1 3 0 0 1 2  4
# 0utpt =  -1 -1 3 3 3 3 -1
...
if __name__ == '__main__':
    arr = [1, 3, 0, 0, 1, 2, 4]
    print(SmallerToLeft(arr))
    print(GreatestToRight(arr))
